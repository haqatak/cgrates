...
func TestDfStorDBJsonCfg(t *testing.T) {
	eCfg := &DbJsonCfg{
		...
		Opts: &DBOptsJson{
			InternalDBDumpPath:        utils.StringPointer("/var/lib/cgrates/internal_db/stordb"),
			InternalDBBackupPath:      utils.StringPointer("/var/lib/cgrates/internal_db/backup/stordb"),
			InternalDBStartTimeout:    utils.StringPointer("5m"),
			InternalDBDumpInterval:    utils.StringPointer("0s"),
			InternalDBRewriteInterval: utils.StringPointer("0s"),
			InternalDBFileSizeLimit:   utils.StringPointer("1GB"),
...
func TestSmgJsonCfg(t *testing.T) {
	eCfg := &SessionSJsonCfg{
		...
		DebitInterval:          utils.StringPointer("0s"),
		StoreSCosts:            utils.BoolPointer(false),
		SessionTTL:             utils.StringPointer("0s"),
		...
		BackupInterval:         utils.StringPointer("0s"),
		...
		Readers: &[]*EventReaderJsonCfg{
			{
				...
				Start_delay:            utils.StringPointer("0"),
